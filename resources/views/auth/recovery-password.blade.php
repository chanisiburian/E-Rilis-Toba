                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('recovery-password') }}" method="post" id="login--form">
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="password" name="password_confirmation" class="form-control form-control-user" placeholder="Masukkan konfirmasi password" id="login--password">
                                    <small class="text-danger error--password"></small>
                                </div>
                            ...
                            <hr>
                            <div class="text-center">
                                Belum punya akun? <a class="small" style="color:#07057a" href="{{ route('auth.register') }}">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
