...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Service Start -->
        <div style="margin-bottom:70px" id="berita">&nbsp;</div>
                ...
                <div class="row g-4">
                    ...
                    @if($value->status == 1)
                        <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                            <div class="service-item d-flex flex-column justify-content-center text-white font-weight-bold text-center rounded" style="background: linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(<?= $value->sampul ?>);background-size: cover;">
                                <h4 class="text-white">{{ $value->judul }}</h4>
                                <h5 class="text-white">Author : {{ $value->user->nama }}</h4>
                                <h5 class="text-white">Tanggal : {{ $value->tanggal_dibuat }}</h4>
                                <h5 class="text-white">Kategori : {{ $value->kategori }}</h4>
                                <h5 class="text-white">{{ $value->isi }}</h4>
                                <a class="btn btn-light px-3 mt-auto mx-auto text-dark" href="{{ $value->url_berita }}">Selengkapnya</a>
                            </div>
                        </div>
                    @endif
                    @endforeach
